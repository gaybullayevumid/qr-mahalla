...
if qr:
    ...
    try:
        response = requests.post(
            "http://127.0.0.1:8000/api/qrcodes/scan/", json={"uuid": qr.uuid}, timeout=5
        )
    ...
    response = requests.post(
        "http://127.0.0.1:8000/api/qrcodes/scan/", json={"uuid": telegram_url}
    )
    ...
    response = requests.post(
        "http://127.0.0.1:8000/api/qrcodes/scan/", json={"qr_code": telegram_url}
    )
