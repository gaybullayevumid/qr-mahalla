...
class QRScanAPIView(APIView):
    ...
    def get(self, request, qr_id):
        ...
        # 🔹 Scan log saqlash (kim, qachon, qayerdan)
        ...
        # 🟢 3. DAVLAT XODIMI / MAHALLA BOSHLIG‘I / SUPER ADMIN
        ...
        # ⚠️ Bu holat deyarli bo‘lmaydi (lekin xavfsizlik uchun)
        return Response(
